...
const terms = () => {
  return (
    <div className=' bg-[#1E1F27] py-8'>
      <div className='container'>
        <div className='text-white'>

          <h1 className='sm:text-2xl text-xl font-bold'>Terms And Conditions</h1>

          <p className='mt-4 sm:text-[16px] text-sm leading-7'>
