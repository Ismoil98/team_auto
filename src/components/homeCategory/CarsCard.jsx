...
const CarsCard = ({data}) => {
  ...
  return (
    <div className='hover:bg-[#24233a] transition-all duration-300 w-fit rounded-3xl'>
        <Link to={'/'} className='block px-4 py-7'>
        <div>
            <img className='w-full max-w-[270px] h-[190px] object-cover' src={`${urlImg}${data.car_images[0].image.src}`} alt="" />
        </div>
        {
            data.inclusive?
            <div className='px-2 py-1 border-[2px] border-red-500 rounded-xl font-bold text-white text-[16px] mt-8'>
